...
<body>
                        ...
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    <div class="inline_control"> <input type="text" name="name" id="name" class="text" placeholder="실명 입력" maxlength="17"> </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value="" placeholder="휴대폰으로 예매내역 문자발송">
                                ...
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div class="inline_control"> <input type="email" name="email" id="email" class="email" value="" placeholder="email@example.com" maxlength="50"> </div>
                                </div>
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected">총 <span id="totalCount">0</span>매 / <span id="totalPrice">0</span>원</p>
                                    </div>
                                </div>
                            </form>
                        </div>
	...
	<script type="text/template" id="bookingItem">
	<div class="qty">
	<div class="id">{{productPriceId}}</div>	
    ...
    <div class="qty_info_icon"> <strong class="product_amount"> <span>{{typeName}}</span> 
	</strong> <strong class="product_price"> <span class="price">{{price}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc">{{discountRate}}% 할인가</em> </div>
	</div>
	</script>
