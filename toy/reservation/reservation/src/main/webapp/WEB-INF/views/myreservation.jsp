	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<a class="btn_my"> <span title="내예약" class="viewReservation">${sessionEmail==null?'예약확인':sessionEmail}</span> </a>
			</header>
		</div>
		<hr>
		<div class="ct">
			<div class="section_my">
				...
				<div class="wrap_mylist">
					<ul class="list_cards" ng-if="bookedLists.length > 0">					
						<li id="confirmedCard" class="card confirmed">
						...
						<li id="usedCard" class="card used">
							<div class="link_booking_details">
								<div class="card_header">
									<div class="left"></div>
									<div class="middle">
							...
							<li id="cancelCard" class="card used cancel">
								<div class="link_booking_details">
									<div class="card_header">
										<div class="left"></div>
										<div class="middle">
			...
			<div class="card_body">
				...
				<div class="middle">
					<div class="card_detail">
						...
						{{/if}}
						{{#if isUsed}}
							<div class="booking_cancel booking_review">
								<button class="btn"><span>예매자 리뷰 남기기</span></button>
								<div class="productId" style="display:none">{{productId}}</div>
							</div>
						{{/if}}
					</div>
				</div>
