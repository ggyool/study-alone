package org.ggyool.calculator.config;
...
@EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = {"org.ggyool.calculator.controller"})
public class MvcConfig implements WebMvcConfigurer {
	...
	private ApiInfo apiInfo() {
		Contact contact = new Contact("홍길동", "https://ggyool.org", "ggyool@ggyool.org");
		ApiInfo apiInfo =
